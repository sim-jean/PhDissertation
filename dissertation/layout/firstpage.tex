...
\newcommand{\NNT}{2024UPASB065} 															%% Numéro National de Thèse (donnée par la bibliothèque à la suite du 1er dépôt)/ National Thesis Number (given by the Library after the first deposit)
...
\begin{textblock}{1}(1.8,11.5)
	\Large{\rotatebox{90}{\color{white}{\fontfamily{fvs}\fontseries{m} \selectfont NNT : \NNT}}}
\end{textblock}
