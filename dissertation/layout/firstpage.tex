...
\newcommand{\juryadressBa}{Chargée de Recherche CNRS, Aix Marseille School of Economics}
...
\begin{textblock}{12}(3.7,2)
	...
	\begin{flushright}
		...
		\vspace{3mm}
		\textbf{Thèse présentée et soutenue à \defenseplace, le \defensedate, par} \bigskip
		\vfill
	...
	%% Jury
	\begin{flushleft}
		\fontfamily{fvs}\fontsize{12}{14}\selectfont
	...
	\begin{tabular}{|p{10cm}l}%{@{} L{9.5cm} R{4.5cm}}
		...
		\jurynameA  \\ \juryadressA & \juryroleA \\ \vspace*{.05cm}
		\jurynameBa  \\ \juryadressBa & \juryroleBa \\ \vspace*{.05cm}
		\jurynameBb  \\ \juryadressBb & \juryroleBb \\ \vspace*{.05cm}
		\jurynameCa  \\ \juryadressCa & \juryroleCa \\ \vspace*{.05cm}
		\jurynameCb  \\ \juryadressCb & \juryroleCb \\ \vspace*{.05cm}
