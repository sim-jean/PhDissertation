...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.45\textwidth]{figures/wildland/distribution_cases_3.png}
    \includegraphics[width = 0.45\textwidth]{figures/wildland/distribution_cases_4.png}
