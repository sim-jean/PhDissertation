...
\begin{document}
    ...
    \include{layout/lastpage.tex}
	\cleardoublepage
    
    \color{black}
    \pagestyle{plain}

    \include{layout/acknowledgements.tex}
    \cleardoublepage
	...
	%\begin{refsection}
	\include{cleaned_chapter1_french}
	%\include{chapter1_v3}
	%{\footnotesize
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\include{Chapter5_v2}
	%\include{Chapter5_for_send_monday}
