...
\documentclass[a4paper, twoside, 11.5pt]{report}
...
\begin{document}
	...
	\begin{appendices}
	\renewcommand{\thesection}{2.\Alph{section}}
	\renewcommand{\thefigure}{2.\Alph{section}.\Alph{figure}}
	\renewcommand{\thetable}{2.\Alph{section}.\Alph{table}}
